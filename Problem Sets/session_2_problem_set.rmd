...
# type will be numeric (first one?)
...
```{r}
task2 <- list(
  data.frame(name = factor(c("Lena", "Phillip", "Marius", "Katharina")), 
             field = factor(c("dentistry", "political science", 
...
task5 <- c(paste0(t, c("st", "nd", "rd", rep("th", 17)), " ", "element"))
```
